...
namespace BusesServer.Controllers
{
    ...
    public class DeparturesController : ControllerBase
    {
        ...
        public IActionResult GetDepartures(int busId, int busStopId, int busRouteId, int hour, int minute, bool busRoutes, bool busRouteDirections, bool busStops)
        {
            var departure = _departuresService.GetDepartures(busId, busStopId, busRouteId, hour, minute, busRoutes, busRouteDirections, busStops);
            return Ok(departure);
        }
